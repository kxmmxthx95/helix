...
import type { AcademicTerm, LeaveType, SalaryGrade, TermStatus, TermType } from "@/lib/database.types";
...
type SettingsTab = "school" | "department" | "terms" | "leave_types" | "salary_grades";
